...
Implement a React hook, `useDeals`, that fetches deal listings through the provided mock API. The backend is already handled for you — focus on the hook, its options, pagination behavior, and tests.
